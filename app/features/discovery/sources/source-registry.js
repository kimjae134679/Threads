(() => {
  const sources = [
    ...
    { id: "naver_news", label: "NAVER 뉴스", family: "news", hosts: ["news.naver.com", "n.news.naver.com"], adapter: "connected-when-credentialed", mode: "official-search-api", autoDiscovery: true, bulkBodyCollection: false, manualCapture: false, note: "NAVER 검색 API 메타데이터/링크 기반. 기사 본문·사진 재사용 권리는 별도." },
    { id: "naver_blog", label: "NAVER 블로그", family: "blog", hosts: ["blog.naver.com"], adapter: "connected-when-credentialed", mode: "official-search-api", autoDiscovery: true, bulkBodyCollection: false, manualCapture: true, note: "NAVER 검색 API로 발견. 본문/이미지 자동 복제 안 함." },
    { id: "naver_cafe", label: "NAVER 카페", family: "community", hosts: ["cafe.naver.com"], adapter: "connected-when-credentialed", mode: "official-search-api-metadata", autoDiscovery: true, bulkBodyCollection: false, manualCapture: true, note: "카페글 검색 API 메타데이터/URL 후보. 실제 원문은 접근권한·약관 확인 후 수동 캡처." },
    { id: "daum_cafe", label: "Daum 카페", family: "community", hosts: ["cafe.daum.net"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "검색 인덱스/사용자 제공 URL 중심. 대량 본문 수집 안 함." },
    ...
    { id: "dcinside", label: "DCInside", family: "community", hosts: ["dcinside.com", "gall.dcinside.com"], adapter: "manual-only", mode: "public-index-metadata-plus-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "개념글/갤 인기 소재는 검색 노출 메타데이터와 사용자 제공 URL·스크린샷으로 반입. 자동 대량 크롤링 안 함." },
    { id: "blind", label: "Blind", family: "community", hosts: ["teamblind.com", "blind.com"], adapter: "manual-only", mode: "public-index-metadata-plus-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "직장 논란/사연 발견용. 자동 scraping 대신 검색 노출/사용자 제공 캡처." },
    { id: "fmkorea", label: "FMKorea", family: "community", hosts: ["fmkorea.com"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "축구·게임·유머·사회 반응 탐색. 사이트별 이용조건 확인 후 adapter 결정." },
    { id: "theqoo", label: "더쿠", family: "community", hosts: ["theqoo.net"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "연예·생활·이슈 반응 발견. 원문 자동 복제하지 않음." },
    { id: "instiz", label: "인스티즈", family: "community", hosts: ["instiz.net"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "연예·생활·관계 이슈 후보 발견용." },
    { id: "clien", label: "클리앙", family: "community", hosts: ["clien.net"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "IT·생활·소비 이슈 탐색. 자동수집 전 이용조건 확인." },
    { id: "ruliweb", label: "루리웹", family: "community", hosts: ["ruliweb.com"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "게임·유머·취미 반응 탐색." },
    { id: "inven", label: "인벤", family: "community", hosts: ["inven.co.kr"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "게임·e스포츠 특화 탐색." },
    { id: "ppomppu", label: "뽐뿌", family: "community", hosts: ["ppomppu.co.kr"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "소비·가격·생활 논쟁 탐색." },
    { id: "arca", label: "아카라이브", family: "community", hosts: ["arca.live"], adapter: "planned", mode: "public-index-or-manual", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "취미·게임·밈 후보 발견. 채널별 성격 차이가 커 Comfort 필터 우선." },
    { id: "tistory", label: "Tistory / 공개 블로그", family: "blog", hosts: ["tistory.com"], adapter: "planned", mode: "rss-or-public-index", autoDiscovery: false, bulkBodyCollection: false, manualCapture: true, note: "RSS/검색 노출 중심. 글 전문 복제 대신 링크·요약 메타데이터." },
