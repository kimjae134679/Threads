...
function candidateCard(item) {
  ...
  card.innerHTML = `
    <div class="card-top">
      ...
      <div class="score-badge" title="운영자 입력 신호 평균에서 소스 위험 패널티를 뺀 초기 점수">${item.score}</div>
    </div>
    <div class="card-meta">
  ...
  card.querySelector(".card-url").textContent = item.url || "직접 입력 소재";
