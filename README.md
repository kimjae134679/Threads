...
후보 상세의 **인스타 게시물 이미지 만들기**에서 원문 캡처 또는 텍스트 본문으로 1080×1350 표지·본문 PNG 세트를 만듭니다. 짧은 큰 제목, 위로 올린 배치, 얇은 검정 테두리를 사용하며 블러는 없습니다. 사용법은 [앱 안내](app/README.md#원문-기반-인스타-표지-제작)를 참고하세요.
